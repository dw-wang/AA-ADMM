...
class TestExamples(BaseTest):
    ...
    def plot_residuals(self):
        ...
        rho_ref1 = r_sAA[0] * np.power((1-np.sqrt(1-self.rho_M)), np.linspace(0, 120, 121))
        rho_ref2 = r_sAA[0] * np.power(self.rho_T2, np.linspace(0, 120, 121))
    ...
    def plot_errors(self):
        # Plot residuals
        e_sAA = self.errors[-1]
        rho_ref1 = e_sAA[0] * np.power((1-np.sqrt(1-self.rho_M)), np.linspace(0, 120, 121))
        rho_ref2 = e_sAA[0] * np.power(self.rho_T2, np.linspace(0, 110, 111))
